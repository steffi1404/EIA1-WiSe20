...
//*REIHENFOLGE SOUNDS-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*//
let beats = ["https://raw.githubusercontent.com/steffi1404/EIA1-SoSe20/master/Steckbrief/Audio/kick.mp3", "https://raw.githubusercontent.com/steffi1404/EIA1-SoSe20/master/Steckbrief/Audio/snare.mp3", "https://raw.githubusercontent.com/steffi1404/EIA1-SoSe20/master/Steckbrief/Audio/hihat.mp3"];
let recording = false;
//*INTERVALL BEAT*//
let beatIntervall = undefined;
...
function playBeat() {
    var index = 0;
    // tslint:disable-next-line: typedef
    beatIntervall = setInterval(function () {
...
function playStop() {
    ...
    if (play.className == "fas fa-play play-button") {
        play.className = "fas fa-stop play-button";
        playBeat();
    }
    else {
        play.className = "fas fa-play play-button";
